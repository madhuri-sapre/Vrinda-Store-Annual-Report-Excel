...
# Project Overview
The purpose of this project is to analyze sales data and uncover meaningful insights about customer behavior, order status, and regional performance. The dashboard provides a quick and clear overview of the store’s key performance indicators (KPIs) for 2022.
...
o	Conditional Formatting <br />


# Files Included
•	Ecommerce_Sales_Analysis_Dashboard.xlsx — The main Excel file containing data and dashboards <br />
•	Screenshots and visuals for presentation/documentation <br />


# How to Use
1.	Download the Excel file from the repository. <br />
...
# Conclusion
The Vrinda Store Annual Report 2022 Dashboard provides an interactive and visual representation of e-commerce sales performance, helping stakeholders understand customer trends, regional success, and platform efficiency — all in a single, easy-to-use interface
